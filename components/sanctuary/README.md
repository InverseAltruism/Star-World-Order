...
This directory hosts the Sanctuary V2 React/Phaser bridge. V2 is the only
sanctuary surface — the Companion view (`app/sanctuary/CompanionView.tsx`) is
the default landing and the Phaser world hub (`app/sanctuary/SanctuaryV2.tsx`,
reached via `?world=1`) is the explore mode. The legacy V1 surface and the V3
tile-engine prototype were removed in the V2 consolidation.
...
on the `NAV_CELL` collision grid and is fully wired.
