...
export default function WalletConnect() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {showNoWalletMessage && (
        <div className="absolute left-1/2 -translate-x-1/2 md:left-auto md:translate-x-0 md:right-0 bottom-full mb-2 w-64 md:w-64 max-h-[60vh] bg-[#1a1a2e] border-2 border-[#ff4466] rounded-lg shadow-xl z-50 overflow-y-auto animate-slide-in-up">
      ...
      {showDropdown && shouldShowDropdown && !showNoWalletMessage && (
        <div className="absolute left-1/2 -translate-x-1/2 md:left-auto md:translate-x-0 md:right-0 bottom-full mb-2 w-56 max-h-[60vh] bg-[#1a1a2e] border-2 border-[#2a2a4e] rounded-lg shadow-xl z-50 overflow-hidden animate-slide-in-up flex flex-col">
