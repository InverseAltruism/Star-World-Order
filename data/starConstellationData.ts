 ...
 * 
 * This file contains the constellation mapping for all 333 Star Skrumpey NFTs.
 * The data is fetched from IPFS metadata and cached locally to avoid rate limiting.
 * 
 ...
 * 1. Run the constellation_list.py script provided in the docs
 * 2. Or use the fetch_constellations.ts script in scripts/
 */

import { StarTraitVariant } from '../lib/starSkrumpey';

/**
 * Complete mapping of Star Skrumpey token IDs to their constellation type.
 * This is the authoritative source for constellation data, fetched directly from IPFS metadata.
 * 
 * Format: { tokenId: constellation }
 * 
 * IMPORTANT: This data was generated by scanning all 333 Star Skrumpey IPFS metadata files.
 * The constellation is extracted from the "constellation" trait_type in each token's attributes.
 */
export const STAR_CONSTELLATION_MAP: Record<number, StarTraitVariant> = {
  // Sorted by token ID for easy lookup and maintenance
  // Data needs to be populated by running the constellation fetch script
  // 
  // Example entry (from token #3189):
  // 3189: 'parallel',
  //
  // The script outputs this mapping by fetching:
  // https://ipfs-proxy.magiceden.dev/ipfs/bafybeibs4foulw6giemwwxwye2qtc3bd2lx34va6c3lpkjvsweevxudsjm/{tokenId}
  // and extracting attributes.find(a => a.trait_type === 'constellation').value
  
  // ============================================================
  // CONSTELLATION DATA - Generated from IPFS metadata
  // Run: npx ts-node scripts/fetch_constellations.ts to regenerate
  // ============================================================
  
  // TOKEN_ID: 'constellation',
  3: 'aether',
  17: 'spectra',
  20: 'aether',
  23: 'aether',
