        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="text-center">
            ...
            <a 
              ...
              className="text-gray-500 text-xs hover:text-[#ffd700] smooth-transition cursor-pointer inline-flex items-center gap-1"
            >
              The Order is forming • <span className="hover:underline">@StrWorldOrder</span>
            </a>
