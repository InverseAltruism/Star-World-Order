...
The following 343 token IDs have been identified as Star Skrumpeys (Skrumpeys with the Star/Constellation trait):
...
This list is stored in `lib/starSkrumpey.ts` as `STAR_SKRUMPEY_IDS` and is used for O(1) lookup when verifying Star Skrumpey ownership.

| File Location | Purpose |
|---------------|---------|
| `lib/starSkrumpey.ts` | Contains `STAR_SKRUMPEY_IDS` array and `isStarSkrumpeyId()` helper |
